...
export default function Card(props: { data: ProjectDataType }) {
  ...
  return (
    <div className="w-96 md:w-80 h-80 py-12 px-8 cursor-pointer bg-white hover:-translate-y-0.5 hover:duration-300 [&:not(:hover)]:translate-y-0.5 [&:not(:hover)]:duration-300 rounded-md">
